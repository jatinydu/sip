  ...
  return (
    <Html lang="en">
      ...
      >
        <Head />
        <Body
          className="m-0 bg-cream font-sans"
          style={{
            fontFamily:
        ...
        >
          <Preview>
            {otp} is your {appName} reset password verification code
          </Preview>
          ...
          <Container className="mx-auto max-w-xl">
            ...
            <Section className="bg-navy rounded-t-lg px-8 py-6 text-center">
              ...
              <Text
                className="m-0 mt-1 text-xs text-white"
            ...
            <Section className="bg-white px-8 py-8">
              ...
              <Text className="m-0 mb-6 text-base leading-7 text-muted">
                Hi {firstName},<br />
                Use the code below to verify your email and complete your new
                password setup.
              </Text>
              ...
              <Text className="m-0 text-sm leading-6 text-muted">
                🔒 Never share this code with anyone. {appName} will never ask
                for your OTP.
              </Text>
            </Section>
            ...
            <Section className="bg-white px-8 pb-6">
              ...
              <Text className="m-0 text-xs text-muted text-center leading-5">
                Sent by <strong style={{ color: "#0F172A" }}>Sip</strong> ·
                Small moments. Big relationships.
                <br />
                You received this because you reset password at getsip.in
              </Text>
            </Section>
